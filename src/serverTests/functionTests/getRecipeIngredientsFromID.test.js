...
} from "../../../server/routes/recipesRoute/getRecipeFromID/getRecipeIngredientsFromID/getRecipeIngredientsFromID";
...
describe("getRecipeIngredientsFromID", () => {
  it("successful circumstance", async () => {
    ...
    expect(recipeIngredients[0].ingredient.ingredientDescription).toBeDefined();
    ...
    expect(recipeIngredients[0].measurementType.measurementType).toBeDefined();
  });
});
...
describe("getIngredientMeasurement", () => {
  it("successful circumstance", async () => {
    ...
    expect(ingredientMeasurement.measurementType.measurementType).toBeDefined();
  });
});

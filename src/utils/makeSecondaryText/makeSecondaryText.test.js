...
describe("makeSecondaryText", () => {
	it("should return the text cut down to 70 characters with ... on the end", () => {
		const description =
		...
		expect(cutDownDescription.length).toBe(73);
		expect(cutDownDescription).toBe(description.slice(0, 70) + "...");
		expect(
